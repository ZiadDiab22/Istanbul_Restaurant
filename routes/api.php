...
Route::get("showCities", [UserController::class, "showCities"]);
Route::get("showDelSer", [AdminController::class, "showDelSer"]);
...
Route::group(["middleware" => ["auth:api"]], function () {
    ...
    Route::get("deleteProduct/{id}", [AdminController::class, "deleteProduct"])->middleware('checkId');
    ...
    Route::post("AddEmploymentRequest", [UserController::class, "AddEmploymentRequest"])->middleware('checkUserId');
    Route::get("showEmploymentRequests", [AdminController::class, "showEmploymentRequests"])->middleware('checkAdminId');
    Route::get("deleteEmploymentRequest/{id}", [AdminController::class, "deleteEmploymentRequest"])->middleware('checkAdminId');
    Route::get("toggleFavourite/{id}", [UserController::class, "toggleFavourite"])->middleware('checkUserId');
    Route::get("showUserData", [AdminController::class, "showUserData"]);
    Route::post("addSale", [AdminController::class, "addSale"])->middleware('checkId');
    Route::post("editSale", [AdminController::class, "editSale"])->middleware('checkId');
    Route::get("showSales", [AdminController::class, "showSales"])->middleware('checkId');
    Route::post("editReqState", [AdminController::class, "editReqState"])->middleware('checkId');
    Route::get("showUserRequests", [UserController::class, "showUserRequests"])->middleware('checkUserId');
    Route::post("addRequestFromweb", [UserController::class, "addRequestFromweb"]);
    Route::post("addRequestFromApp", [UserController::class, "addRequestFromApp"])->middleware('checkUserId');
    Route::get("showAllRequests", [AdminController::class, "showAllRequests"])->middleware('checkId');
    Route::post("showStats", [AdminController::class, "showStats"])->middleware('checkAdminId');
});
